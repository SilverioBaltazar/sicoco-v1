...
class catalogosfuncionesController extends Controller
{
    ...
    public function actionVerFuncion(){
        ...
        $id_estructura= rtrim($id_estruc," ");
        $rango        = session()->get('rango');
        $regfuncion = regFuncionModel::join('COMB_CAT_PROCESOS','COMB_CAT_PROCESOS.PROCESO_ID','=',
                                                                'COMB_CAT_FUNCIONES.PROCESO_ID')
                      ->select('COMB_CAT_FUNCIONES.PROCESO_ID','COMB_CAT_PROCESOS.PROCESO_DESC',
                               'COMB_CAT_FUNCIONES.FUNCION_ID','COMB_CAT_FUNCIONES.FUNCION_DESC',
                               'COMB_CAT_FUNCIONES.FUNCION_STATUS','COMB_CAT_FUNCIONES.FUNCION_FECREG')
                      ->orderBy('COMB_CAT_FUNCIONES.PROCESO_ID','DESC')
                      ->orderBy('COMB_CAT_FUNCIONES.FUNCION_ID','DESC')
                      ->paginate(30);
    ...
    public function actionEditarFuncion($id){
        ...
        //$regfuncion = regFuncionModel::join('COMB_CAT_PROCESOS','COMB_CAT_PROCESOS.PROCESO_ID','=','COMB_CAT_FUNCIONES.PROCESO_ID')
        //                    ->select('COMB_CAT_FUNCIONES.PROCESO_ID','COMB_CAT_PROCESOS.PROCESO_DESC','COMB_CAT_FUNCIONES.FUNCION_ID','COMB_CAT_FUNCIONES.FUNCION_DESC','COMB_CAT_FUNCIONES.FUNCION_STATUS','COMB_CAT_FUNCIONES.FUNCION_FECREG')
        //                    ->where('FUNCION_ID',$id)
        //                    ->orderBy('COMB_CAT_FUNCIONES.PROCESO_ID','COMB_CAT_FUNCIONES.FUNCION_ID','DESC')
        //                    ->get();
