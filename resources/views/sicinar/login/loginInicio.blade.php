...
<body class="hold-transition">
  ...
  <div class="login-box">
    ...
    <div class="login-logo">
      <h5 style="color:orange;"><b>SISTEMA DE CONTROL DE COMBUSTIBLE <br>(SICOCO v.1)<br>
                                   ÁREA DE COMBUSTIBLES</b></h5>
    ...
    <div class="login-logo"><br>
      ...
      <h6 style="color:green;"><b>SECRETARIA DE DESARROLLO SOCIAL <br> UDITI-AREA DESARROLLO DE PROYECTOS</b></h6>
    </div>
  </div>
  ...
  <!--{!! JsValidator::formRequest('App\Http\Requests\usuarioRequest','#logeo') !!} -->
    {!! JsValidator::formRequest('App\Http\Requests\loginuserRequest','#logeo') !!}
</body>
@endsection