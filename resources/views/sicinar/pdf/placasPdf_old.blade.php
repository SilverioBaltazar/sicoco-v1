                ...
                <tr>
                    ...
                    @foreach($regmarca as $marca)
                        @if($marca->marca_id == $placa->marca_id)
                            <td style="text-align:justify;vertical-align: middle;"><b style="color:black;font-size: xx-small;">{{$marca->marca_desc}}</b></td>
                        @else
                    ...
                    @foreach($regtipogasto as $gasto)
                        @if($gasto->tipog_id == $placa->tipog_id)
                            <td style="text-align:justify;vertical-align: middle;"><b style="color:black;font-size: xx-small;">{{$gasto->gasto_desc}}</b></td>
                        @else
                            <td style="text-align:justify;vertical-align: middle;"><b style="color:black;font-size: xx-small;">**</b></td>                            
                        @endif
                    @endforeach 
                    @foreach($regtipooper as $oper)
                        @if($oper->tipoo_id == $placa->tipoo_id)
                            <td style="text-align:justify;vertical-align: middle;"><b style="color:black;font-size: xx-small;">{{$oper->tipoo_desc}}</b></td>
                        @else
                            <td style="text-align:justify;vertical-align: middle;"><b style="color:black;font-size: xx-small;">***</b></td>                            
                        @endif
                    @endforeach 
