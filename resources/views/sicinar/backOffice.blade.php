...
<div class="wrapper">
    ...
    <footer class="main-footer">
        <div class="pull-right hidden-xs"><b>Versión 1.0</b> UDITI-Area de Desarrollo de Proyectos.</div>
        <strong>Copyright &copy; 2019. Derechos reservados. Secretaría de Desarrollo Social - Gobierno del Estado de México. 
        </strong>
    </footer>
</div>
<!-- jQuery 3 -->
