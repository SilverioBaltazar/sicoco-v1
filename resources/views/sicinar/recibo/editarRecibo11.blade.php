            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => ['actualizarRecibo11',$regrecibos->recibo_folio], 'method' => 'PUT', 'id' => 'actualizarRecibo11', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="row">    
                                @if (!empty($regrecibos->recibo_rfoto1)||!is_null($regrecibos->recibo_rfoto1))  
                                    <div class="col-xs-12 form-group">
                                        <label >Archivo de recibo de bitacora para descarga de combustible en formato PDF</label>
                                        <label ><a href="/images/{{$regrecibos->recibo_rfoto1}}" class="btn btn-danger" title="Archivo de recibo de bitacora para descarga de combustible en formato PDF"><i class="fa fa-file-pdf-o"></i>{{$regrecibos->recibo_rfoto1}}</a>
                                        </label>
                                    </div>   
                                    <div class="col-xs-12 form-group">
                                        <label >Actualizar Archivo de recibo de bitacora para descarga de combustible en formato PDF</label>
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\recibo11Request','#actualizarRecibo11') !!}
@endsection
