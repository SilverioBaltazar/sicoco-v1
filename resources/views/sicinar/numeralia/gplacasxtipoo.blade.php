...
@section('title','Estadística por tipo de operación admon.')
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Placas por tipo de operación admon. </li>
      </ol>
    </section>
        ...
        <div class="col-md-6">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title"><b>Estadística de placas por tipo de operación admon.</b></h3>
              ...
              <table id="tabla1" class="table table-striped table-bordered table-sm">
                <thead style="color: brown;" class="justify">
                  <tr>
                    ...
                    <th rowspan="2" style="text-align:left;"  >TIPO OP. ADMON.</th>
                ...
                <tbody>
                  @foreach($regplaca as $placa)
                      <tr>
                        <td style="color:darkgreen;">{{$placa->tipoo_id}}</td>
                        <td style="color:darkgreen;">{{$placa->tipoo_desc}}   </td>
                        <td style="color:darkgreen; text-align:center;">{{$placa->total}}   </td>
                      </tr>
                  @endforeach
                  @foreach($regtotxtipoo as $totales)
                      <tr>
                        <td></td>
                        <td style="color:green;"><b>TOTAL</b></td>                         
                        <td style="color:green; text-align:center;"><b>{{$totales->totalxtipoo}} </b></td>              
                      </tr>
                  @endforeach
                </tbody>
              </table>
...
@section('javascrpt')
  ...
  <script type="text/javascript">
      ...
      function drawStuff() {
        ...
        var options = {
          title: 'Por Tipo de operación admon.',
          width: 500,                   // Ancho de la pantalla horizontal
          height: 300,                  // Alto de la pantall '75%',          
          legend: { position: 'none' },
          chart: { title: 'Gráfica de Barras',
                   subtitle: 'Placas por tipo de op. admon. ' },
  ...
  <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Gráfica por Tipo de op. admon.',
          pieHole: 0.4,
          width: 500,                   // Ancho de la pantalla horizontal
          height: 300,                  // Alto de la pantall '75%',
        };
